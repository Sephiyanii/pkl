...
<body>
    ...
    <div class="vizew-pager-area">
        <div class="vizew-pager-prev">
            ...
            <!-- Single Feature Post -->
            <div class="single-feature-post video-post bg-img pager-article" style="background-image: url({{ asset('assets/frontend/img/bg-img/15.jpg')}});">
                <!-- Post Content -->
        ...
        <div class="vizew-pager-next">
            ...
            <!-- Single Feature Post -->
            <div class="single-feature-post video-post bg-img pager-article" style="background-image: url({{ asset('assets/frontend/img/bg-img/14.jpg')}});">
                <!-- Post Content -->
                <div class="post-content">
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget p-0 author-widget">
                            <div class="p-4">
                                <img class="author-avatar" src="{{ asset('assets/frontend/img/bg-img/30.jpg')}}" alt="">
