          ...
          <div class="col-md-6 text-center heading-section ftco-animate">
    		...
    		<div class="row no-gutters">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="{{ asset('assets/frontend/images/work-1.jpg') }}" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Stylist</span>
	    					<h3><a href="gallery.blade.php">Makeup</a></h3>
	    				</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="{{ asset('assets/frontend/images/work-2.jpg') }}" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="{{ asset('assets/frontend/images/work-3.jpg') }}" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Makeup</a></h3>
	    				</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="{{ asset('assets/frontend/images/work-4.jpg') }}" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Makeup</a></h3>
	    				</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="{{ asset('assets/frontend/images/work-5.jpg') }}" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Makeup</a></h3>
	    				</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="{{ asset('assets/frontend/images/work-6.jpg') }}" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Fashion</span>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="{{ asset('assets/frontend/images/work-7.jpg') }}" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Makeup</a></h3>
	    				</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="{{ asset('assets/frontend/images/work-8.jpg') }}" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Makeup</a></h3>
	    				</div>
