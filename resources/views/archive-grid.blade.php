                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/40.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/41.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/42.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/43.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/44.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/45.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/46.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/47.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/48.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="{{ asset('assets/frontend/img/bg-img/49.jpg')}}" alt="">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="index.html" class="foo-logo d-block mb-4"><img src="{{ asset('assets/frontend/img/core-img/log')}}o2.png" alt=""></a>
