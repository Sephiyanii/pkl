...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('assets/fronted/img/core-img/favicon.ico')}}">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="typography-content mb-50">
                        ...
                        <!-- Single Feature Post -->
                        <div class="single-feature-post video-post bg-img mb-30" style="background-image: url({{ asset('assets/frontend/img/bg-img/14.jpg')}}')}});">
                            <!-- Play Button -->
