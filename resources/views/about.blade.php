...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url({{ asset('assets/frontend/images/bg-2.jpg') }});" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5">
            <h2 class="mb-0 bread">About Us</h2>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.blade.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>About <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 d-flex">
						<div class="p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url({{ asset('assets/frontend/images/about.jpg')}});">
        		...
        		<div class="carousel-team owl-carousel">
        			<div class="item">
		        		<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url({{ asset('assets/frontend/images/stylist-1.jpg')}});"></div>
		        			<h2>Danica Lewis</h2>
        			...
        			<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url({{ asset('assets/frontend/images/stylist-2.jpg')}});"></div>
		        			<h2>Nicole Simon</h2>
	        		...
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url({{ asset('assets/frontend/images/stylist-3.jpg')}});"></div>
		        			<h2>Cloe Meyer</h2>
	        		...
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url({{ asset('assets/frontend/images/stylist-4.jpg')}});"></div>
	        		...
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url({{ asset('assets/frontend/images/stylist-5.jpg')}});"></div>
		        			<h2>Dave Buff</h2>
	            ...
	            <div class="carousel-testimony owl-carousel ftco-animate">
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url({{ asset('assets/frontend/images/stylist-1.jpg')}})">
		                  </div>
		                  <div class="pos ml-3">
	              ...
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url({{ asset('assets/frontend/images/stylist-2.jpg')}})">
		                  </div>
		                  <div class="pos ml-3">
		                  	<p class="name">Jeff Nucci</p>
		                    <span class="position">Businessman</span>
	              ...
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url({{ asset('assets/frontend/images/stylist-3.jpg')}})">
		                  </div>
		                  <div class="pos ml-3">
		                  	<p class="name">Jeff Nucci</p>
		                    <span class="position">Businessman</span>
	              ...
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url({{ asset('assets/frontend/images/stylist-4.jpg')}})">
		                  </div>
		                  <div class="pos ml-3">
		                  	<p class="name">Jeff Nucci</p>
		                    <span class="position">Businessman</span>
	              ...
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url({{ asset('assets/frontend/images/stylist-5.jpg')}})">
		                  </div>
		                  <div class="pos ml-3">
		                  	<p class="name">Jeff Nucci</p>
		                    <span class="position">Businessman</span>
